...
app.use(express.static(__dirname)); // Menyajikan file statis dari direktori root aplikasi
...
app.post('/upload', upload.single('file'), (req, res) => {
    ...
    const csvFilename = `${baseName}.csv`; // Nama file CSV baru
...
// Endpoint untuk menerima permintaan filter
